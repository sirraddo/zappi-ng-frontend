...
function SocialButtons({ onProfile, mode = "login" }) {
  const providers = [
    ...
    },
    {
      ...
      bg: "#25D366", border: "#25D366", color: "white",
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, overflowY: "auto" }}>
      ...
      <div style={{ padding: 20 }}>
        ...
        <div style={{ textAlign: "center", margin: "20px 0", display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ flex: 1, height: 1, background: "#E5E7EB" }} />
          <span style={{ fontSize: 12, color: "#aaa", fontWeight: 500 }}>or fill in manually</span>
          <div style={{ flex: 1, height: 1, background: "#E5E7EB" }} />
        </div>
      ...
      <div style={{ flex: 1, padding: 20 }}>
        ...
        {method === "password" && (
          <div>
            ...
            {!mobileBrowser ? (
              <button style={{ width: "100%", background: "white", border: "1.5px solid #E5E7EB", borderRadius: 14, padding: 14, fontSize: 14, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, boxShadow: "0 2px 8px rgba(0,0,0,0.06)", marginTop: 10 }}
